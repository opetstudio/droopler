...
($context["view_mode"] ?? null)) ? (("paragraph--view-mode--" . \Drupal\Component\Utility\Html::getClass($this->sandbox->ensureToStringAllowed(($context["view_mode"] ?? null))))) : (""))];
        // line 46
        $context["paragraph_classes"] = [0 => "d-p-banner", 1 => "background-image"];
        // line 50
...
";
    ...
    {
        return new Source("", "profiles/contrib/droopler/modules/custom/d_p_banner/templates/paragraph--d-p-banner.html.twig", "/opt/lampp/htdocs/droopler/web/profiles/contrib/droopler/modules/custom/d_p_banner/templates/paragraph--d-p-banner.html.twig");
    }
}
